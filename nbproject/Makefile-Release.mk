...
${OBJECTDIR}/src/includes/jsoncpp.o: src/includes/jsoncpp.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/includes/jsoncpp.o src/includes/jsoncpp.cpp

${OBJECTDIR}/src/includes/parametros.o: src/includes/parametros.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/includes
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/includes/parametros.o src/includes/parametros.cpp
