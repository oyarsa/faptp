...
${OBJECTDIR}/src/Aleatorio.o: src/Aleatorio.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Aleatorio.o src/Aleatorio.cpp

${OBJECTDIR}/src/AlunoPerfil.o: src/AlunoPerfil.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/AlunoPerfil.o src/AlunoPerfil.cpp

${OBJECTDIR}/src/Disciplina.o: src/Disciplina.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Disciplina.o src/Disciplina.cpp

${OBJECTDIR}/src/Grade.o: src/Grade.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Grade.o src/Grade.cpp

${OBJECTDIR}/src/Horario.o: src/Horario.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Horario.o src/Horario.cpp

${OBJECTDIR}/src/PTP.o: src/PTP.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/PTP.o src/PTP.cpp

${OBJECTDIR}/src/Professor.o: src/Professor.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Professor.o src/Professor.cpp

${OBJECTDIR}/src/ProfessorDisciplina.o: src/ProfessorDisciplina.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ProfessorDisciplina.o src/ProfessorDisciplina.cpp

${OBJECTDIR}/src/Representacao.o: src/Representacao.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Representacao.o src/Representacao.cpp

${OBJECTDIR}/src/Resolucao.o: src/Resolucao.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Resolucao.o src/Resolucao.cpp

${OBJECTDIR}/src/Solucao.o: src/Solucao.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Solucao.o src/Solucao.cpp

${OBJECTDIR}/src/UUID.o: src/UUID.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/UUID.o src/UUID.cpp

${OBJECTDIR}/src/Util.o: src/Util.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Util.o src/Util.cpp

${OBJECTDIR}/src/includes/jsoncpp.o: src/includes/jsoncpp.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/includes
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/includes/jsoncpp.o src/includes/jsoncpp.cpp

${OBJECTDIR}/src/includes/parametros.o: src/includes/parametros.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/includes
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/includes/parametros.o src/includes/parametros.cpp
